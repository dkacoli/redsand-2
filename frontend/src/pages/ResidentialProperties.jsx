...
export default function ResidentialProperties() {
  ...
  const fetchProperties = async (filters = {}) => {
    setLoading(true);
    try {
      const params = new URLSearchParams({ property_type: "residential", ...filters });
  ...
  return (
    <div data-testid="residential-properties-page" className="min-h-screen pt-24 md:pt-32">
      {/* Hero Section */}
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gold/10 border border-gold/20 mb-6">
            ...
            <span className="text-xs uppercase tracking-wider text-gold">Luxury Living</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-white/60 font-light max-w-2xl mx-auto">
            Find your dream home in Dubai's most prestigious neighborhoods. 
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <PropertyFilter onFilterChange={handleFilterChange} propertyType="residential" />
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-white/50 max-w-md mx-auto">
                No residential properties match your current filters. 
                Try adjusting your search criteria or contact us for exclusive listings.
              </p>
            </div>
          )}
        </div>
